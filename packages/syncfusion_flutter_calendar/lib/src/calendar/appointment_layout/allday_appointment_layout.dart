...
class AllDayAppointmentLayout extends StatefulWidget {
  ...
  /// selection.
  final ValueNotifier<SfSelectionDetails?> repaintNotifier;
...
class _AllDayAppointmentRenderObject extends CustomCalendarRenderObject {
  ...
  ValueNotifier<SfSelectionDetails?> _selectionNotifier;

  ValueNotifier<SfSelectionDetails?> get selectionNotifier =>
      _selectionNotifier;

  set selectionNotifier(ValueNotifier<SfSelectionDetails?> value) {
  ...
  void _updateSelectionDecorationPainter() {
    selectionNotifier.value = SfSelectionDetails(
